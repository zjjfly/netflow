...
object NetFlowV5Packet {
  ...
  /**
    ...
    */
  def apply(sender: InetSocketAddress, buf: ByteBuf): Try[NetFlowV5Packet] =
    Try[NetFlowV5Packet] {
  ...
  def apply(sender: InetSocketAddress,
            ...
            uptime: Long,
            timestamp: DateTime,
            samplingInterval: Int): Option[NetFlowV5] =
    Try[NetFlowV5] {
  ...
  private def doLayer[T](
      f: FlowPacketMeta[NetFlowV5Packet] => Future[T]): Future[T] =
